...
public class FamilyQuest extends AppCompatActivity {
    ...
    Button button;
    String quest[]={"가족끼리 안마해드리기 ","가족에게 맛있는 저녁 만들어 주기","가족들에게 감사인사 전하기" , "사랑한다고 말하기" ,"가족과 포옹하기", "이번 주 힘들었던 점들을 나누기",
            "가족들과 재밌는 영화보기" , "어렸을 적 사진 보기" , "다함께 집 청소 하기" , "함께 빨래널기" ,"가족과 포옹하기",
            "가족끼리 용돈주기","가족과 함께 친척에게 놀러가기"}; //13개
    int questCnt=0;



    String quest2[]={"가족들과 주말에 약속잡기","가족들과 재밌는 영화보기","다함께 집 청소 하기" ,"자녀에게 용돈주기","가족과 함께 친척에게 놀러가기","가족에게 편지쓰기","가족과 포옹하기",
            "가족끼리 용돈주기","가족과 함께 친척에게 놀러가기","가족들과 재밌는 영화보기" , "어렸을 적 사진 보기" , "다함께 집 청소 하기"};
    int questCnt2=0;
